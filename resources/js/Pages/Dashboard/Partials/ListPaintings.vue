    ...
    <div class="bg-white overflow-hidden shadow sm:rounded-lg">
                        ...
                        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <table class="min-w-full">
                                <thead class="bg-gray-50 border-b border-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200" v-if="paintings.length !== 0">
                                        <draggable v-model="props.paintings" tag="transition-group" item-key="name"
                                            handle=".handle" v-bind="dragOptions" :component-data="{
                                            ...
                                            <template #item="{ element }">
                                                <tr>
                                                    <td class="h-full flex-col ml-2">
                                                        <menu-alt-4-icon class="handle w-6 h-6 grid place-self-center" />
                                                    </td>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="text-sm text-gray-900">{{ element.make }}</div>
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="text-sm text-gray-900">{{ element.views }}</div>
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <jet-checkbox :checked="element.sold != 0
                                                            " @change="
        updateSold(
            $event,
            element.id
        ...
        " />
                                    ...
                                    <div v-else class="px-6 py-4">
                                        <span class="text-xs text-gray-500 italic sm:text-sm">Nog geen schilderijen.</span>
                                    </div>
                                </table>
                                <div
                                    ...
                                    <jet-action-message :on="reorderForm.recentlySuccessful" class="ml-3">Opgeslagen.
                                    </jet-action-message>
                            </div>
                        </div>
                    </div>
...
import { TrashIcon, PencilIcon, EyeIcon, MenuAlt4Icon } from "@heroicons/vue/solid";
