                        ...
                        " :style="'background-image: url(\'' + photoPreview + '\');'
                            ">
                                                                            ...
                                                                            <div class="flex items-center gap-x-8">
                                                                                ...
                                                                                <jet-button type="button" @click="rotate" v-if="!photoPreview">
                                                                                    Draaien
                                                                                </jet-button>
                                                                            </div>
...
async function rotate() {
    ...
    await rotateForm.put(route('rotate', props.painting.slug))
    setTimeout(() => {
